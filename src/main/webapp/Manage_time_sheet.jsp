        ...
        <ul>
            <li>
                ...
                <div class="options">
                    ...
                    <button onclick="deleteTimeSheet(1)">Delete</button>
                </div>
            </li>
            <li>
                Feb, 2023
                <div class="options">
                    ...
                    <button onclick="deleteTimeSheet(2)">Delete</button>
                </div>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul>
            <li>
                Jan, 2023
                <div class="options">
                    <button onclick="viewTimeSheet(3)">View</button>
                    <button onclick="editTimeSheet(3)">Edit</button>
                    <button onclick="deleteTimeSheet(3)">Delete</button>
                </div>
            </li>
        </ul>
    </li>
        ...
        <ul>
            <li>
                ...
                <nav>
                        ...
                        <button onclick="navigateToView109()">View</button></nav>
                    <nav><button onclick="navigateToEdit109()">Edit</button></nav>
                    <nav><button onclick="navigateTodelete109()">Delete</button></nav>
                </div>
            </li>
        </ul>
    </li>
...
<script>
    function viewTimeSheet(timeSheetId) {
        ...
        window.location.href = 'view_timesheet.jsp';
    }

    function editTimeSheet(timeSheetId) {
        // Add logic to edit time sheet
        window.location.href = 'Edit_timesheet.jsp';
    }

    function deleteTimeSheet(timeSheetId) {
        // Add logic to delete time sheet
        window.location.href = 'delete_timesheet.html';
    }

    function navigateToView109(){
        // Add logic to view time sheet details
        window.location.href = 'view_timesheet109.jsp';
    }

    function navigateToEdit109() {
        // Add logic to edit time sheet
        window.location.href = 'Edit_timesheet109.jsp';
    }

    function navigateTodelete109() {
        // Add logic to delete time sheet
        window.location.href = 'delete_timesheet109.jsp';
    }
</script>
</body>
</html>
